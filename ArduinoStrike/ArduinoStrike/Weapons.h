...
inline WeaponData GetWeaponData(Weapon weapon, double modifier)
{
    ...
    case UMP:
        return {
            ...
            { 15, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 85, 90, 90, 85, 90, 90, 3000 }
        };

    case M4A1:
        return {
            { 1 * modifier, 0 * modifier, -4 * modifier, 4 * modifier, -6 * modifier, -4 * modifier, 14 * modifier, 8 * modifier, 18 * modifier, -14 * modifier, -25 * modifier, -19 * modifier, -22 * modifier, 1 * modifier, 8 * modifier, -9 * modifier, -11 * modifier, 5 * modifier, 3 * modifier, 3 * modifier },
            { 6 * modifier, 4 * modifier, 14 * modifier, 18 * modifier, 21 * modifier, 20 * modifier, 14 * modifier, 12 * modifier, 5 * modifier, 5 * modifier, -3 * modifier, 0 * modifier, -3 * modifier, 3 * modifier, 3 * modifier, 1 * modifier, -2 * modifier, 2 * modifier, 1 * modifier, 1 * modifier },
            { 88, 88, 88, 88, 88, 88, 88, 88, 88, 88, 88, 88, 88, 88, 88, 88, 88, 88, 88, 3000 }
        };
    ...
    case M4A4:
        return {
            ...
            { 15, 88, 87, 87, 87, 87, 87, 88, 88, 88, 88, 88, 88, 88, 88, 87, 87, 87, 87, 88, 88, 88, 88, 88, 88, 87, 87, 87, 87, 3000 }
        };
    ...
    case AK47:
        return {
            ...
            { 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 3000 }
        };
    ...
    case GALIL:
        return {
            ...
            { 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 50, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 3000 }
        };
    ...
    case FAMAS:
        return {
            ...
            { 30, 88, 88, 88, 88, 88, 88, 88, 88, 88, 88, 88, 87, 88, 88, 88, 88, 88, 80, 88, 80, 84, 80, 88, 3000 }
        };
    ...
    case SG:
        return {
            ...
            { 99, 99, 99, 99, 99, 99, 45, 45, 45, 45, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 45, 45, 45, 45, 99, 99, 99, 3000 }
        };
